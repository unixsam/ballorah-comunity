      ...
      compileCore: {
        ...
        files: {
          '<%= config.compilePath.css %>/<%= pkg.name %>.css': '<%= config.srcPath.less %>/style.less',
	        '<%= config.compilePath.css %>/<%= pkg.name %>-rtl.css': '<%= config.srcPath.less %>/style-rtl.less'
        }
      },
      minify: {
        options: {
        ...
        files: {
          ...
          '<%= config.compilePath.css %>/<%= pkg.name %>.min-rtl.css': '<%= config.compilePath.css %>/<%= pkg.name %>-rtl.css'
        }
      }
    },
    ...
    copy: {
      fonts: {
        ...
        src: [
          ...
          '<%= config.srcPath.fontunivers %>/*',
          '<%= config.srcPath.droid %>/*',
	  '<%= config.srcPath.motcfonts %>/*'
        ],
