/*!
 *  Bootstrap based theme v1.0.0 (http://phptux.com)
 * Copyright 2016-2016 PHPTUX
 * Licensed under Creative Commons (BY-SA) (http://creativecommons.org/licenses/by-sa/3.0/)
  */
/* ========================================================================
...
!function($) {
    ...
    Sidemenu.prototype.menuItemClick = function(e) {
       if(!$("#wrapper").hasClass("enlarged")){
        ...
        if(!$(this).hasClass("subdrop")) {
          ...
          $(".drop-arrow i",$(this).parents(".has-childs:first")).removeClass("zmdi-chevron-right").addClass("zmdi-chevron-down");
    ...
    Sidemenu.prototype.init = function() {
      ...
      $("#sidebar-menu ul li.has-childs a.active").parents("li:last").children("a:first").addClass("active").trigger("click");
    },
